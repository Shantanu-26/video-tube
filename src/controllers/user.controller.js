    ...
    User.findByIdAndUpdate(req.user?._id,
        {
            $set: {
                fullName,
                email: email           //both fullName and email syntax are same
            }
        },
        {new: true}    
    ).select("-password")
...
//         {
//             $lookup: {
//                 from: "subscriptions",    //in a model everything converts to lowercase i.e. Subscription to subscriptions
//                 localField: "_id",
